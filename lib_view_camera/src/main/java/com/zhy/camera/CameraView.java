...
public class CameraView extends FrameLayout {
    ...
    public boolean isShutterSound() {
        return mImpl.isShutterSound();
    }

    public void setShutterSound(boolean sound) {
        if (sound) {
            mImpl.setShutterCallback(new Camera.ShutterCallback() {
                @Override
            ...
            mImpl.setShutterCallback(null);
        }
    }

    void setTakePicFocus(boolean focus) {
        mImpl.setTakePicFocus(focus);
    }

    boolean getTakePicFocus() {
        return mImpl.getTakePicFocus();
    }

    public void setShutterCallback(Camera.ShutterCallback shutterCallback) {
        mImpl.setShutterCallback(shutterCallback);
    }

    public void setPictureSize(Size pic_size) {
        mImpl.setDefPictureSize(pic_size);
    }

    public void updatePictureSize(Size pic_size) {
        mImpl.updatePictureSize(pic_size);
    }

    public SortedSet<Size> getPictureSizes() {
        return mImpl.getPictureSizes();
    }
